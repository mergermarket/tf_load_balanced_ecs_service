    ...
    def test_create_ecs_service(self):
        ...
        assert dedent("""
            + module.service.aws_ecs_service.service
                ...
                ordered_placement_strategy.2093792364.field:        "attribute:ecs.availability-zone"
                ordered_placement_strategy.2093792364.type:         "spread"
                ordered_placement_strategy.3946258308.field:        "instanceId"
                ordered_placement_strategy.3946258308.type:         "spread"
